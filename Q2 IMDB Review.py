...
for i in range(1,21):
  ip=[]  
  url="https://www.imdb.com/title/tt10698680/reviews/?ref_=tt_ql_urv"+str(i)  
  ...
  KGF2_reviews = KGF2_reviews + ip  # adding the reviews of one page to empty list which in future contains all the reviews

# writng reviews in a text file 
# saving the reviews in a textt file i.e., oneplus as text file
with open("K.G.F2.txt", "w", encoding='utf8') as output:
    output.write(str(KGF2_reviews))
...
ip_rev_string = " ".join(KGF2_reviews)
...
stop_words.extend(["KGF 2","acting","K.G.F 2","action","fight","fighting","mass","violence","KGF","kgf"])
...
customised_words = ['rocky hype', 'prashant neel','rocky hype','sanjay dutt','kannada film'] # If you want to remove any particular word form text which does not contribute much in meaning
